...
def get_materials():
    with open("../article_prep/title_locations.json") as f:
    ...
    for k, v in filtered_title_locations.items():
        ...
        for doc in docs:
            ...
            if doc_dict.get("entity_address") is not None and doc_dict["entity_address"] != [] and doc_dict["entity_address"] != {'address': []}:
